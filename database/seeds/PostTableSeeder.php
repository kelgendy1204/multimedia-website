...
class PostTableSeeder extends Seeder
{
	...
	public function run()
	{
		...
		DB::table('posts')->insert(array(
			 array(
			 	'id'=> 1,
			 	'title'=>'اغنية اصالة نصري - لا تروح CD Q 320 Kbps',
			 ...
			 array(
			 	'id'=> 2,
			 	'title'=>'البوم نانسي عجرم -حاسه بيك 2017 Cd Q 320Kpbs',
			 ...
			 array(
			 	'id'=> 3,
			 	'title'=>'فيلم صابر جوجل بطولة محمد رجب و سارة سلامة نسخه HDRip',
			 ...
			 array(
			 	'id'=> 4,
			 	'title'=>'Split 2016 480p & 720p BluRay مترجم',
